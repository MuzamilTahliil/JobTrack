  ...
  useEffect(() => {
    const fetchUser = async () => {
      ...
      if (error) {
        ...
        if (userError) {
          console.error('Error fetching user first name:', userError);
        } else {
          ...
          <div className="grid items-center grid-cols-1 gap-12 lg:grid-cols-2">
            <div className="text-center lg:text-left">
              <h1 className="text-4xl font-bold text-gray-800 sm:text-5xl lg:text-6xl">
                Hello {firstName ? firstName : "there"}, let's find your
              ...
              <div className="mt-8 sm:flex sm:items-center sm:space-x-8 justify-center lg:justify-start">
                <a href="/AllJobs" className="inline-flex items-center justify-center px-10 py-4 text-base font-semibold text-white bg-orange-500 hover:bg-white hover:text-black focus:bg-blue-700 transition-all duration-200 rounded-md shadow-lg">
                  Start Exploring
                </a>
              </div>
            </div>
        ...
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12 mt-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300">
              ...
              <Link to="/AllJobs" className="inline-flex mt-4 items-center justify-center px-6 py-2 text-base font-semibold text-white bg-orange-500 hover:bg-orange-600 focus:bg-orange-600 rounded-md transition-all duration-200">
                Explore Jobs
              </Link>
            </div>
